...
const String GIALLI_CSV = '_formazioneGialli.txt';
const String VERDI_CSV = '_formazioneVerdi.txt';
...
final http.Response DEFAULT_TIMEOUT_RESPONSE =
    http.Response("", 500, reasonPhrase: "TIMEOUT ERROR");
...
//region permissions
List<Permission> STORAGE_PERMISSIONS = [
  Permission.storage,
  Permission.manageExternalStorage,
  Permission.mediaLibrary,
];

List<Permission> STORAGE_33_PERMISIONS = [
  Permission.videos,
  Permission.photos,
  Permission.audio,
];
